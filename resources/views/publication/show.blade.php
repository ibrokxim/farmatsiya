    ...
    <div class="container-fluid py-3" style="background-color: #f8f9fa;">
      <div class="row">
        <div class="col-12 d-flex flex-column">
          <h1 class="main_title mb-4">Автор: {{$states->fio}}</h1>
          <h3 class="main_title mb-4">ORCID_ID: {{$states->orcid_id}}</h3>
          <h3 class="main_title mb-4">Название работы: {{$states->short_name}}</h3>
          <div class="w-100 d-flex  flex-column flex-lg-row">
            <div>
              <div class="main_el">Аннотация: <br>{{$states->annotation}}</div>
              <h1 class="main_title mb-4">Скачать статью:
              <a href="https://www.farmatsiya.uz/storage/app/public/{{$states->files}}"  class="btn btn-default btn--size" download>
                    <i class="fa fa-download"></i>                   </a>
            </h1>
            <h1 class="main_title mb-4">Дата отправки: {{$states->created_at}}</h1>
            </div>
