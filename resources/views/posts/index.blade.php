...
<font style="color: #000000">Автор: {{$post->title}}</font>
        <br>
        <font style="color: #171E83">Название:</font><font style="color:#000000">{!! \Illuminate\Support\Str::words($post->name,10) !!}</font>
        <br>
        <font style="color: #171E83" "&nbsp;">Страница:</font><font style="color:#000000">{{$post->preview}}</font>                                
    <br>
</div>
</a>   
@empty
<h3 class="fw-bold fs-4" style="margin-left: 600px;">@lang('index.yuborilgan')</h3>
@endforelse
